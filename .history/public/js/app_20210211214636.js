...
function  WeatherApi(){
    ...
    citys.forEach(el => {
       fetch(`http://api.openweathermap.org/data/2.5/weather?q=${el}&units=metric&appid=2b1ec7a5b325cfbf7c1bc18b936df3f3`).then( res => res.json()).then(displayWeather(citys))
    })
}

function displayWeather(citys, req){
    console.log(citys)
}
