...
function  WeatherApi(){
    var url = 'api.openweathermap.org/data/2.5/weather?q=Paris&unit=metric&appid=2b1ec7a5b325cfbf7c1bc18b936df3f3'
    var result = {}
   var tr = window.fetch(url).then( res => res.json()).then(req => console.log(req))
    console.log(tr)
}
